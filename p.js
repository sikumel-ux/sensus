...
const REDIRECT_THANK_YOU_URL = "done"; 
let rowCount = 0;
        ...
        <div class="form-grid">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px;">
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrapper">
                        <select class="form-control input-gol-darah">
                            <option value="-">-</option>
...
function prosesKolektifKirimData(e) {
    ...
    for (let i = 0; i < rows.length; i++) {
        ...
        payloadAnggota.push({
            ...
            golDarah: row.querySelector(".input-gol-darah").value,
    ...
    .then(database => {
        ...
        for (let nikKandidat of listNik) {
            let adaNikDiDb = database.some(item => item.nik === nikKandidat || item.nik === "'" + nikKandidat);
        ...
        const payloadSensus = {
            ...
            hpBosMess: (statusRumahValue === "Mess") ? document.getElementById("nama_pemilik_toko_mess").value : "-", 
